...
/* Command for C compiler:
   clang -c  -w -pthread  -I/usr/local/Cellar/nim/0.17.2/nim/lib -o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_posix.o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_posix.c */
