...
/* Command for C compiler:
   clang -c  -w -pthread  -I/usr/local/Cellar/nim/0.17.2/nim/lib -o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_ospaths.o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_ospaths.c */
...
{	NimTV_ = (NimThreadVars*) GetThreadLocalVars();
	...
	nimln_(107, "osenv.nim");
	{
		...
		result = copyStr(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[i], (NI)(TM_jvWQYw9bcuYhftfPX2ynPeg_34));
		goto BeforeRet_;
	}
	goto LA1_;
	LA3_: ;
