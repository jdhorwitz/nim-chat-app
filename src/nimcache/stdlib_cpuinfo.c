...
/* Command for C compiler:
   clang -c  -w -pthread  -I/usr/local/Cellar/nim/0.17.2/nim/lib -o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_cpuinfo.o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_cpuinfo.c */
...
N_NIMCALL(NI, ncpicountProcessors)(void) {
	...
	numCPU = (NI)0;
	len = (size_t)0;
	nimln_(55, "cpuinfo.nim");
	mib[(((NI) 0))- 0] = ((int) 6);
	nimln_(56, "cpuinfo.nim");
	mib[(((NI) 1))- 0] = ((int) 25);
	nimln_(57, "cpuinfo.nim");
	len = ((NI) 8);
	nimln_(58, "cpuinfo.nim");
	T1_ = (int)0;
	T1_ = sysctl(mib, ((int) 2), ((void*) ((&numCPU))), (&len), NIM_NIL, ((NI) 0));
	T1_;
	nimln_(59, "cpuinfo.nim");
	{
		int T6_;
		if (!(numCPU < ((NI) 1))) goto LA4_;
		nimln_(60, "cpuinfo.nim");
		mib[(((NI) 1))- 0] = ((int) 3);
		nimln_(61, "cpuinfo.nim");
		T6_ = (int)0;
		T6_ = sysctl(mib, ((int) 2), ((void*) ((&numCPU))), (&len), NIM_NIL, ((NI) 0));
		T6_;
	}
	LA4_: ;
	nimln_(62, "cpuinfo.nim");
	result = numCPU;
