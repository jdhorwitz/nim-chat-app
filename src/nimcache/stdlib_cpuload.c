...
/* Command for C compiler:
   clang -c  -w -pthread  -I/usr/local/Cellar/nim/0.17.2/nim/lib -o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_cpuload.o /Users/joshuahorwitz/nim/ChatApp/src/nimcache/stdlib_cpuload.c */
...
N_NIMCALL(tyEnum_ThreadPoolAdvice_vD9cAMuSmfH29a9al5Q9cUZCig, advice_9bmaXUZIEfSc9ax0Tn2TlQng)(tyObject_ThreadPoolState_jN9benzGjAA9bryIHC1FGnZA* s) {
	...
	NI TM_CFWzmO8DEHxStvjr8GyqGg_2;
	...
	TM_CFWzmO8DEHxStvjr8GyqGg_2 = addInt((*s).calls, ((NI) 1));
	(*s).calls = (NI)(TM_CFWzmO8DEHxStvjr8GyqGg_2);
	popFrame();
	return result;
}
